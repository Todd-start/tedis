 ...
 */
public class TedisClusterHystrixClient extends TechwolfHystrixJedisCluster implements JedisCommands,
        MultiKeyJedisClusterCommands, JedisClusterScriptingCommands {

    private static final Logger logger = LoggerFactory.getLogger(TedisClusterHystrixClient.class);

    public TedisClusterHystrixClient(TechwolfJedisConfig config) {
        super(config);
    }
